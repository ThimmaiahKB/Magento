...
namespace Rathan\Eavattribute\Setup\Patch\Data;
    ...
    public function apply()
    {
        ...
        try {
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(CustomerMetadataInterface::ENTITY_TYPE_CUSTOMER, 'key');

            // Make attribute visible in Admin customer form
            $attribute->setData('used_in_forms', ['adminhtml_customer','customer_address_edit','adminhtml_customer_address', 'customer_register_address','customer_account_edit', 'customer_account_create']);
