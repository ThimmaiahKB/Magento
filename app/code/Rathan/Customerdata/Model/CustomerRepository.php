...
use Rathan\Customerdata\Model\CustomerFactory;
use Rathan\Customerdata\Model\ResourceModel\Customer as ObjectResourceModel;
use Rathan\Customerdata\Model\ResourceModel\Customer\CollectionFactory;
...
class CustomerRepository implements CustomerRepositoryInterface
{
    ...
    {
        try {
            $this->objectResourceModel->save($customer);
        } catch (\Exception $e) {
